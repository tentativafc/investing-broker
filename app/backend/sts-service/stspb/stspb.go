...
var file_sts_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x3f, 0x0a, 0x03, 0x53, 0x74, 0x73,
	0x12, 0x38, 0x0a, 0x0d, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x12, 0x11, 0x2e, 0x73, 0x74, 0x73, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x73, 0x74, 0x73, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x05, 0x5a, 0x03, 0x73, 0x74,
...
var file_sts_proto_goTypes = []interface{}{
	(*TokenRequest)(nil),  // 0: sts.TokenRequest
	(*TokenResponse)(nil), // 1: sts.TokenResponse
}
var file_sts_proto_depIdxs = []int32{
	0, // 0: sts.Sts.GenerateToken:input_type -> sts.TokenRequest
	1, // 1: sts.Sts.GenerateToken:output_type -> sts.TokenResponse
...
func (c *stsClient) GenerateToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sts.Sts/GenerateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Sts_GenerateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sts.Sts/GenerateToken",
	}
